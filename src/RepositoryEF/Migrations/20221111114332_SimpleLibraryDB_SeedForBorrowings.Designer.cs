...
namespace RepositoryEF.Migrations
{
    ...
    [Migration("20221111114332_SimpleLibraryDB_SeedForBorrowings")]
    partial class SimpleLibraryDB_SeedForBorrowings
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Models.Borrowing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CopyId = 4,
                            ReaderId = 1,
                            StartedDate = new DateTime(2022, 11, 11, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            Id = 5,
            ...
            modelBuilder.Entity("Entities.Models.Copy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.Models.Borrowing", b =>
                {
                    b.HasOne("Entities.Models.Copy", "Copy")
                        .WithMany()
