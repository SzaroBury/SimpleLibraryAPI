...
public class LibraryEFContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Book>().HasData(
            new Book { Id = 1, Title = "Some old book",         AuthorId = 1, CategoryId = 1, Language = Language.English,    ReleaseDate = new DateTime(1900, 1, 1) },
            new Book { Id = 2, Title = "Some old German book",  AuthorId = 1, CategoryId = 1, Language = Language.German,     ReleaseDate = new DateTime(1800, 1, 1) },
            new Book { Id = 3, Title = "Some new French book",  AuthorId = 1, CategoryId = 2, Language = Language.French,     ReleaseDate = new DateTime(2010, 5, 7) },
            new Book { Id = 4, Title = "Dziady część II",       AuthorId = 2, CategoryId = 2, Language = Language.Polish,     ReleaseDate = new DateTime(1823, 1, 1) },
            new Book { Id = 5, Title = "Dziady część III",      AuthorId = 2, CategoryId = 2, Language = Language.Polish,     ReleaseDate = new DateTime(1832, 1, 1) });
